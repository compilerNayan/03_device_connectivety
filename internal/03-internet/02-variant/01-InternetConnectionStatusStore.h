...
class InternetConnectionStatusStore : public IInternetConnectionStatusStore {
    ...
    Public Void SetState(Bool internetConnected, ULong internetConnectionId) override {
        ...
        public: static IInternetConnectionStatusStorePtr GetInstance() {
            static IInternetConnectionStatusStorePtr instance(new InternetConnectionStatusStore());
            return instance;
        }
};

template <>
struct Implementation<IInternetConnectionStatusStore> {
    using type = InternetConnectionStatusStore;
};
