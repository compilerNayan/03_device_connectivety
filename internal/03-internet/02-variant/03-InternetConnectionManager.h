...
class InternetConnectionManager : public IInternetConnectionManager {
    /*--@Autowired--*/
IWiFiConnectionManagerPtr wiFiConnectionManager = Implementation<IWiFiConnectionManager>::type::GetInstance();
    /*--@Autowired--*/
IInternetConnectionStatusStorePtr internetStatusStore = Implementation<IInternetConnectionStatusStore>::type::GetInstance();
    /*--@Autowired--*/
ILoggerPtr logger = Implementation<ILogger>::type::GetInstance();
    ...
    Public Virtual Void RestartNetwork() override {
        ...
        public: static IInternetConnectionManagerPtr GetInstance() {
            static IInternetConnectionManagerPtr instance(new InternetConnectionManager());
            return instance;
        }
};
...
template <>
struct Implementation<IInternetConnectionManager> {
    using type = InternetConnectionManager;
};
