...
class WiFiConnectionStatusStore : public IWiFiConnectionStatusStore {
    ...
    Public Void SetState(Bool wiFiConnected, Bool hotspotConnected,
        ...
        public: static IWiFiConnectionStatusStorePtr GetInstance() {
            static IWiFiConnectionStatusStorePtr instance(new WiFiConnectionStatusStore());
            return instance;
        }
};

template <>
struct Implementation<IWiFiConnectionStatusStore> {
    using type = WiFiConnectionStatusStore;
};
